...
class MetabaseTestHelper:
    ...
    def __init__(self, base_url: str, email: str = "admin@example.com", password: str = "Admin123!"):
    ...
    def wait_for_metabase(self, timeout: int = 300, interval: int = 10) -> bool:
        ...
        while time.time() - start_time < timeout:
            ...
            time.sleep(interval)
            logger.debug(f"Still waiting for Metabase... ({int(time.time() - start_time)}s elapsed)")
    ...
    def add_database(self, name: str, host: str, port: int, dbname: str, 
                     user: str, password: str) -> Optional[int]:
        """
    ...
    def create_card(self, name: str, database_id: int, collection_id: Optional[int] = None,
                   query: Optional[Dict[str, Any]] = None) -> Optional[int]:
        """
        ...
        try:
            if query is None:
                ...
                query = {
                    ...
                    "type": "query",
                    "query": {
                        "source-table": 1  # Assuming first table
                    }
                }
    ...
    def create_dashboard(self, name: str, collection_id: Optional[int] = None,
                        card_ids: Optional[List[int]] = None) -> Optional[int]:
        """
        Create a dashboard.
    ...
    def _add_card_to_dashboard(self, dashboard_id: int, card_id: int,
